...
class AssistantMethods {
  static Future<String> searchCoordinateAddress(
    ...
    if (response != 'failed') {
      ...
      add1 = response["results"][0]['address_components'][1]
          ['long_name']; //neighborhood
      add2 = response["results"][0]['address_components'][2]
          ['long_name']; //sublocality
      add3 = response["results"][0]['address_components'][3]
          ['long_name']; //administrative_area_level_2
      add4 = response["results"][0]['address_components'][4]
          ['long_name']; //country
      add5 = response["results"][0]['address_components'][5]['long_name'];

      add6 = response["results"][0]['address_components'][6]
